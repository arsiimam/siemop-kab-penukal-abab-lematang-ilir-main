        ...
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($q) {
                ...
                if (Auth::user()->can('Edit Role')) {
                    $output .= '<a href="#" class="modal-btn-xl tooltip-custom" data-title="' . __('Edit') . '" data-url="' . route('roles.edit', $q->id) . '" data-toggle="modal" data-backdrop="static">
                ...
                if (Auth::user()->can('Delete Role')) {
                    $output .= '
                    <form method="post" action="' . route('roles.destroy', $q->id) . '" style="display:inline">
