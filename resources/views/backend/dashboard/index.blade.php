    ...
    <div class="row">
            ...
            <div class="card card-bg">
                <div class="card-header p-0 position-relative">
                    <div class="position-absolute handle card-icon">
                        <i class="iconsminds-tag-3 dashboard-icon-size"></i>
                    </div>
                </div>
                <div class="card-body d-flex justify-content-between align-items-center">
                    <h6 class="mb-0">Perangkat Daerah</h6>
        ...
        <div class="col-xl-4 col-lg-4 mb-4">
            <div class="card card-bg">
                <div class="card-header p-0 position-relative">
                    <div class="position-absolute handle card-icon">
                        <i class="iconsminds-male-female dashboard-icon-size"></i>
                    </div>
                </div>
                <div class="card-body d-flex justify-content-between align-items-center">
    ...
    <div class="row">
        <div class="col-md-12 mb-4">
            <div class="card" style="height: 400px !important;">
                <div class="card-body">
                    <h5 class="card-title">Grafik Realisasi Perangkat Daerah {{ recent_month() }}</h5>
    ...
    <div class="row">
        <div class="col-lg-4 col-sm-12 mb-4">
            <div class="card dashboard-progress">
                <div class="card-body">
                    <h5 class="card-title">Status Kegiatan {{ recent_month() }}</h5>

                    <div class="scroll dashboard-logs">

                        @foreach ($list_institutes as $item)
                            <div class="mb-4">
                                <p class="mb-2">
                                    <span>{{ strtoupper($item->dinas) }}</span>
                                    <span class="float-right text-muted">{{ $item->done . '/' . $item->total }}</span>
                                </p>
                                <div class="progress">
                                    <div class="progress-bar" role="progressbar"
                                        aria-valuenow="{{ ($item->done / $item->total) * 100 }}" aria-valuemin="0"
        ...
        <div class="col-md-4 mb-4">
            <div class="card" style="height: 385px !important;">
                <div class="card-body">
                    <h5 class="card-title">Login Aktivitas</h5>
                            ...
                            <tbody>
                                @foreach ($logs as $item)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <span
                                                class="text-muted">{{ date('d-m-Y H:i', strtotime($item->created_at)) }}</span>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
        ...
        <div class="col-md-4 mb-4">
            <div class="card dashboard-sq-banner justify-content-end">
                <div class="card-body justify-content-end d-flex flex-column">
                    <span class="badge badge-pill badge-theme-3 align-self-start mb-3">{{ ENV('DS_APP_NAME') }}</span>
                    <p class="lead text-white">{{ ENV('DS_APP_DESC') }}</p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <tbody>
                            @foreach ($announcement as $item)
                                <tr>
                                    ...
                                    <td>
                                        {{ $item->institute_id != null ? $item->institute->name : 'SEMUA Perangkat Daerah' }}
                                    </td>
