        ...
        <div class="btn-group" role="group">
            @can('Create Announcement')
                <button type="button" class="btn btn-primary top-right-button mb-2 mr-1 modal-btn" style="width: 80px;"
                    data-title="{{ __('Tambah Data Baru') }}" data-url="{{ route('announcement.create') }}" data-toggle="modal"
...
@section('content')
    <div class="row mb-4">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    {{ $dataTable->table(['class' => 'table table-striped dataTable responsive'], false) }}
                </div>
            </div>
        </div>
    </div>
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            url: "{{ url('api/announcement/bulk-delete') }}",
                            type: "post",
                            data: {
                                id: deleteids_arr
                            },
