...
@section('header')
    <h1>{{ __('Perangkat Daerah / Instansi') }}</h1>
@endsection
        ...
        <div class="btn-group" role="group">
            @can('Create Institute')
                <button type="button" class="btn btn-primary top-right-button mb-2 mr-1 modal-btn" style="width: 80px;"
                    data-title="{{ __('Tambah Data Baru') }}" data-url="{{ route('institute.create') }}" data-toggle="modal"
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            url: "{{ url('api/institute/bulk-delete') }}",
                            type: "post",
                            data: {
                                id: deleteids_arr
                            },
